 ...
 *
 *
 *  Requires the following to be listed in either your dojoConfig (if using dojo), or in your require.config (if using requirejs)
 *      jquery - use 1.11 or better - earlier versions do not support AMD directly.  Used for ajax and some dom manipulations
 *      jquery-ui - used for the jquery-ui version of the dialog
 *      hogan - used to render the templates
 ...
 *
 * was using xstyle when using the dojo loader, but had some difficulties with it with require.  Now using the require-css plugin
 *
...
define([], function () {
    ...
    return {
        ...
        constructor: function () {
            ...
            */
            require(['css!/Content/test'], function () {
